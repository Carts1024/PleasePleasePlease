namespace PleasePleasePlease
{
    partial class UC_Booking1
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel9 = new Panel();
            buttonBookingImport = new Button();
            panel11 = new Panel();
            ...
            panel9.Controls.Add(buttonBookingImport);
            ...
            // buttonBookingImport
            // 
            buttonBookingImport.BackColor = Color.FromArgb(27, 67, 50);
            buttonBookingImport.FlatAppearance.BorderColor = Color.FromArgb(27, 67, 50);
            buttonBookingImport.FlatStyle = FlatStyle.Flat;
            buttonBookingImport.Font = new Font("Microsoft Sans Serif", 14.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
            buttonBookingImport.ForeColor = Color.White;
            buttonBookingImport.Location = new Point(949, 88);
            buttonBookingImport.Margin = new Padding(3, 4, 3, 4);
            buttonBookingImport.Name = "buttonBookingImport";
            buttonBookingImport.Size = new Size(223, 58);
            buttonBookingImport.TabIndex = 19;
            buttonBookingImport.Text = "Import Records";
            buttonBookingImport.UseVisualStyleBackColor = false;
            buttonBookingImport.Click += buttonBookingImport_Click;
            // 
            // panel11
            // 
            ...
            // panelListofBooking
            // 
            panelListofBooking.AutoSize = true;
        ...
        private Button buttonBookingImport;
    }
}
